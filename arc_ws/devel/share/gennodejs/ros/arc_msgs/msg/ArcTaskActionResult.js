...
class ArcTaskActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArcTaskResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ArcTaskResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArcTaskActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ArcTaskResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ArcTaskResult()
    }
...
module.exports = ArcTaskActionResult;
