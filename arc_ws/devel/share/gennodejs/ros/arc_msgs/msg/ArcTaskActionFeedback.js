...
class ArcTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArcTaskFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArcTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArcTaskActionFeedback(null);
    ...
    data.feedback = ArcTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArcTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArcTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArcTaskFeedback()
    }
...
module.exports = ArcTaskActionFeedback;
