...
"""autogenerated by genpy from arc_msgs/DetectedRobots.msg. Do not edit."""
import sys
...
class DetectedRobots(genpy.Message):
  _md5sum = "620e76eebd9864092c079930b5b956dd"
  _type = "arc_msgs/DetectedRobots"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """arc_msgs/DetectedRobot[] robots		#list of the robots detected
...
"""
  __slots__ = ['robots']
  _slot_types = ['arc_msgs/DetectedRobot[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DetectedRobots, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = arc_msgs.msg.DetectedRobot()
        start = end
        end += 4
