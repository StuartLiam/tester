...
"""autogenerated by genpy from arc_msgs/ArcTaskActionFeedback.msg. Do not edit."""
import sys
...
class ArcTaskActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "arc_msgs/ArcTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arc_msgs/ArcTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArcTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = arc_msgs.msg.ArcTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = arc_msgs.msg.ArcTaskFeedback()
