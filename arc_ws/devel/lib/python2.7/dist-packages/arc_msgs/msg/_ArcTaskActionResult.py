...
"""autogenerated by genpy from arc_msgs/ArcTaskActionResult.msg. Do not edit."""
import sys
...
class ArcTaskActionResult(genpy.Message):
  _md5sum = "e2e90d2dfe1d4055d91acbb70008dd42"
  _type = "arc_msgs/ArcTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','arc_msgs/ArcTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArcTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = arc_msgs.msg.ArcTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = arc_msgs.msg.ArcTaskResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_Bi().pack(_x.result.completed, _x.result.task_id))
      _x = self.result.final_state
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.completed, _x.result.task_id,) = _get_struct_Bi().unpack(str[start:end])
      ...
      if python3:
        self.result.final_state = str[start:end].decode('utf-8')
      else:
        self.result.final_state = str[start:end]
      return self
